#!/bin/bash
# ──────────────────────────────────────────────────────────
# [Clean Architecture] Infrastructure Layer - Build Script
# 역할: apps/ 디렉토리를 .img 디스크 이미지로 빌드
# 수행범위: 이미지 생성/포맷/파일복사. OS 로직 포함 금지
# 의존방향: 호스트 빌드 도구(dd, mkfs, mount)
# SOLID: SRP — OS 이미지 빌드만 담당
# ──────────────────────────────────────────────────────────
