...
├─────────────────────────────────────────┤
│      System Services (D-Bus IPC)        │  ← 25개 시스템 서비스
├─────────────────────────────────────────┤
...
#### OS 이미지 서비스 (apps/system/services.js — 25개 비즈니스 로직):
...
| + 16개 D-Bus 서비스 | 위 테이블의 모든 서비스 포함 |
...
- **OS 시스템 서비스**: `apps/system/` — services.js(25개 서비스 비즈니스 로직), permissions.js(권한 시행), security.js(보안 정책)
